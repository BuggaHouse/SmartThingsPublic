...
metadata {
    ...
    definition (name: "Carrier Thermostat", namespace: "ace", author: "Stefano Acerbetti") {
        capability "Sensor"
        capability "Actuator"
        ...
        command "setCarrierHome"
        command "setCarrierAway"
        command "setCarrierWake"
        command "setCarrierSleep"
...
private setCarrierHome() {
	setOperatingState(OP_STATE.HOME)
}
private setCarrierAway() {
	setOperatingState(OP_STATE.AWAY)
}
private setCarrierSleep() {
	setOperatingState(OP_STATE.SLEEP)
}
private setCarrierWake() {
	setOperatingState(OP_STATE.WAKE)
}
